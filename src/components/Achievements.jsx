...
const LeadershipItem = ({ item, index }) => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-between mb-12 md:mb-16 w-full group">
      {/* Timeline line dot */}
      <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-4 h-4 bg-[#700215] rounded-full border-4 border-black z-30 shadow-[0_0_15px_#700215] group-hover:scale-125 transition-transform duration-300" />
      ...
      >
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:border-[#700215]/30 hover:shadow-[0_15px_35px_rgba(112,2,21,0.1)] transition-all duration-500">
          ...
          <h3 className="text-white text-xl font-black mb-1 tracking-tight group-hover:text-[#700215] transition-colors">
            {item.title}
          </h3>
          <p className="text-[#700215] text-xs font-bold font-mono tracking-wider uppercase mb-4">
            {item.role}
          </p>
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-20 text-center">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-lg mx-auto leading-relaxed">
            Hackathons, awards, and major project milestones.
          </p>
        </div>
        ...
        <div className="relative w-full">
          ...
          <div className="absolute left-4 md:left-1/2 -translate-x-1/2 top-2 bottom-2 w-[2px] bg-gradient-to-b from-[#700215] via-[#700215]/50 to-white/10" />
