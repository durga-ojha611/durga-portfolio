...
const CertificateCard = ({ cert, aosDelay }) => {
  const CardContent = (
    <div 
      ...
      className="bg-black/20 backdrop-blur-sm rounded-2xl p-5 border border-white/10 hover:border-white/25 hover:scale-105 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] transition-all duration-500 group h-full"
    >
  ...
  return cert.url ? (
    <a href={cert.url} target="_blank" rel="noopener noreferrer" className="block cursor-pointer">
      {CardContent}
    </a>
  ) : (
...
const Certificates = () => {
  return (
    <section className="bg-[#700215] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" data-aos-delay="700" className="flex justify-center">
          ...
          >
            <svg className="w-5 h-5 text-[#700215]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
