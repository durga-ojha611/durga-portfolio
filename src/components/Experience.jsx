...
const Experience = () => {
  return (
    <section className="bg-[#700215] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            Professional experience where I applied engineering skills in a real-world team setting.
          </p>
        </div>
