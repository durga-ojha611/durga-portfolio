...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden bg-[#FB2A29]">
      ...
      {/* Main Content (remains visible even when video is unmuted) */}
        ...
        <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
          ...
          <div className="flex flex-col items-start text-left max-w-2xl w-full">
            ...
            >
              ...
              <span className="text-transparent [-webkit-text-stroke:1.5px_white] drop-shadow-sm">{heroContent.titleHighlight}</span>
            </h1>
          ...
          {/* Right Side: Play/Pause Reel Button */}
          <div
            data-aos="zoom-in"
            data-aos-delay="600"
            ...
            onClick={isPlayingReel ? closeReel : openReel}
          >
            <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#700215] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(112,2,21,0.6)]">
              {isPlayingReel ? (
